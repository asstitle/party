<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\PHPTutorial\WWW\xx\public/../application/xyb\view\curriculum\add_ks.html";i:1563677876;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form method="post" action='<?php echo url("Curriculum/add_ks_post"); ?>' class="form-horizontal" onsubmit="return check()">
