<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:71:"D:\PHPTutorial\WWW\xx\public/../application/xyb\view\question\edit.html";i:1563712567;s:59:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\head.html";i:1563603505;s:61:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\header.html";i:1563603560;s:62:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\sidebar.html";i:1563693627;s:66:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\breadcrumbs.html";i:1563610337;s:58:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\set.html";i:1562840357;s:61:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\footer.html";i:1562840357;s:63:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\footerjs.html";i:1562897379;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                                    ...
                                    <form class="form-horizontal margin-top-20" action="" method="post" onsubmit="return check()" id="forms">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4">
                                                <select name="cat_id" id="cat_id">
                                                    <option value="0" <?php if($res['cat_id'] == 0): ?>selected="selected"<?php endif; ?>>请选择</option>
                                                    ...
                                                    <option value="<?php echo $v['id']; ?>" <?php if($res['cat_id'] == $v['id']): ?>selected="selected"<?php endif; ?>><?php echo $v['cat_name']; ?></option>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-md-4 col-sm-4" id="items">
                                                <?php if($result): if(is_array($result) || $result instanceof \think\Collection || $result instanceof \think\Paginator): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?>
                                                    <label><input name='selectradio' type='radio' <?php if($r['is_answer'] == 1): ?>checked="checked"<?php endif; ?>/><input class='item' type='text' style='width:350px' value="<?php echo $r['answer']; ?>"  data-value="<?php echo $r['id']; ?>"/></label><br><br>
...
<script type="application/javascript">
    $(".btn-add").click(function(){
        ...
        $.ajax({
            type:"post",
            url:"/xyb/Question/edit_post/tag_id/"+tag_id,
