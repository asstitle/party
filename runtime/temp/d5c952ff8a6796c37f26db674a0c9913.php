<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:69:"D:\PHPTutorial\WWW\xx\public/../application/xyb\view\course\edit.html";i:1563692279;s:59:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\head.html";i:1563603505;s:61:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\header.html";i:1563603560;s:62:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\sidebar.html";i:1563692026;s:66:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\breadcrumbs.html";i:1563610337;s:58:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\set.html";i:1562840357;s:61:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\footer.html";i:1562840357;s:63:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\footerjs.html";i:1562897379;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
            ...
            <li class="">
                ...
                <ul class="submenu" <?php if(in_array(($tag_id), explode(',',"4,5"))): ?>style="display:block"<?php endif; ?>>
                    <li <?php if($tag_id == 4): ?>class='active' <?php endif; ?>>
                        <a href="<?php echo url('Curriculum/add',['tag_id'=>4]); ?>">
                            <i class="menu-icon fa fa-caret-right"></i>
                            新建课程
                        </a>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="tabbable">
                                    ...
                                    <form class="form-horizontal margin-top-20" action="<?php echo url('Course/edit_post',['tag_id'=>$tag_id]); ?>" method="post" onsubmit="return check()">
                                        <div class="form-group">
                                            <label for="input-parent_id" class="col-sm-2 control-label"><span style="color: red">*</span>上级</label>
                                        ...
                                        <div class="form-group">
                                            <label for="input-name" class="col-sm-2 control-label"><span style="color: red">*</span>分类名称</label>
                                            <div class="col-md-6 col-sm-10">
                                                <input type="text" class="form-control" id="input-name" name="cat_name" value="<?php echo $info['name']; ?>">
                                            </div>
                                        </div>
