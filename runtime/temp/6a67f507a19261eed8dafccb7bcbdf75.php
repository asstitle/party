<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:72:"D:\PHPTutorial\WWW\xx\public/../application/xyb\view\question\index.html";i:1563705371;s:59:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\head.html";i:1563603505;s:61:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\header.html";i:1563603560;s:62:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\sidebar.html";i:1563693627;s:66:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\breadcrumbs.html";i:1563610337;s:58:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\set.html";i:1562840357;s:61:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\footer.html";i:1562840357;s:63:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\footerjs.html";i:1562897379;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                            ...
                            <div class="col-xs-12">
                                <div class="tabbable">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li><a href="<?php echo url('Question/add',['tag_id'=>$tag_id]); ?>">添加题目</a></li>
                                    </ul>
                                    ...
                                    <form class="form-horizontal" method="post" action="<?php echo url('Test/index',['tag_id'=>$tag_id]); ?>">
                                        <div class="form-group">
                                            <div class="col-sm-2">
                                                <select name="cat_id">
                                                    <option value="0" <?php if($cat_id == 0): ?>selected="selected"<?php endif; ?>>全部</option>
                                                    <?php if(is_array($cat_list) || $cat_list instanceof \think\Collection || $cat_list instanceof \think\Paginator): $i = 0; $__LIST__ = $cat_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?>
                                                    <option value="<?php echo $c['id']; ?>" <?php if($cat_id == $c['id']): ?>selected="selected"<?php endif; ?>><?php echo $c['cat_name']; ?></option>
                                            ...
                                            <tbody>
                                               <?php if(is_array($arr) || $arr instanceof \think\Collection || $arr instanceof \think\Paginator): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                                 <tr>
                                                     ...
                                                     <td>
                                                         <?php if(is_array($v['answer_list']) || $v['answer_list'] instanceof \think\Collection || $v['answer_list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $v['answer_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?>
                                                         <?php echo $vv['answer']; ?><br/>
                                                         <?php endforeach; endif; else: echo "" ;endif; ?>
                                                     </td>
                                                     <td>
                                                         <a  class="aset" href="<?php echo url('Question/edit',['tag_id'=>$tag_id,'id'=>$v['id']]); ?>">编辑</a>
                                                         <a  class="aset" onclick="del(<?php echo $v['id']; ?>)">删除</a>
                                                     </td>
                                                 </tr>
                                               <?php endforeach; endif; else: echo "" ;endif; ?>
                                            </tbody>
...
<script>
    ...
    function del(id){
        layer.confirm('确定删除？',{'icon':3,'title':'删除'},function(data){
            $.post('/xyb/Question/del',{id:id},function(res){
                if(res.state==1){
                    layer.msg(res.info, {
                        icon: 1,
