<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:74:"D:\PHPTutorial\WWW\xx\public/../application/xyb\view\curriculum\index.html";i:1563692566;s:59:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\head.html";i:1563603505;s:61:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\header.html";i:1563603560;s:62:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\sidebar.html";i:1563693627;s:66:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\breadcrumbs.html";i:1563610337;s:58:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\set.html";i:1562840357;s:61:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\footer.html";i:1562840357;s:63:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\footerjs.html";i:1562897379;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                            ...
                            <div class="col-xs-12">
                                <div class="tabbable">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li><a href="<?php echo url('curriculum/add',['tag_id'=>$tag_id]); ?>">新建课程</a></li>
                                    </ul>
                                    <div style="margin-top: 20px;"></div>
                                    <form class="form-horizontal" method="post" action="<?php echo url('Curriculum/index',['tag_id'=>$tag_id]); ?>">
                                        <div class="form-group">
                                            <div class="col-sm-2">
                                               <select name="p_id" id="p_id" style="width: 80%;">
                                                   <option value="0">全部</option>
                                                   <?php if(is_array($p_list) || $p_list instanceof \think\Collection || $p_list instanceof \think\Paginator): $i = 0; $__LIST__ = $p_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?>
                                    ...
                                    <form class="js-ajax-form" method="post">
                                        <table class="table table-hover table-bordered table-list" id="menus-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><img src="/uploads/<?php echo $i['pic']; ?>" style="margin: 10px;" width="80px" height="80px"/></td>
                                                    <td><?php echo $i['curriculum_name']; ?></td>
                                                    <td><?php echo $i['curriculum_intro']; ?></td>
                                                    <td><?php echo $i['browse_num']; ?></td>
                                                    <td><?php echo $i['study_num']; ?></td>
                                                    <td><?php echo $i['create_name']; ?></td>
                                                    <td><?php echo $i['curriculum_score']; ?></td>
                                                    <td>
                                                        <a href="<?php echo url('Curriculum/ks_manager',['tag_id'=>$tag_id,'kid'=>$i['id']]); ?>" class="aset">课时管理</a>
                                                        <a href="<?php echo url('Curriculum/edit',['tag_id'=>$tag_id,'kid'=>$i['id']]); ?>" class="aset">编辑</a>
                                                        <a onclick="del_info(<?php echo $i['id']; ?>)" class="aset">删除</a>
                                                    </td>
...
<script>
    ...
    function del_info(id){
        layer.confirm('该课程及课程内容将一并删除,确定？',{'icon':3,'title':'删除'},function(data){
            $.post('/xyb/Curriculum/delete_info',{id:id},function(res){
                if(res.state==1){
                    layer.msg(res.info, {
                        icon: 1,
