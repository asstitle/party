<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:79:"D:\PHPTutorial\WWW\xx\public/../application/xyb\view\curriculum\ks_manager.html";i:1564909162;s:59:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\head.html";i:1563603505;s:61:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\header.html";i:1563603560;s:62:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\sidebar.html";i:1563693627;s:66:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\breadcrumbs.html";i:1563610337;s:58:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\set.html";i:1562840357;s:61:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\footer.html";i:1562840357;s:63:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\footerjs.html";i:1562897379;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="tabbable">
                                    ...
                                    <button class="btn btn-sm btn-primary iframe" value="<?php echo url('Curriculum/add_ks',['kid'=>$kid]); ?>" cate="1">
                                        ...
                                        <table class="table table-hover table-bordered table-list" id="menus-table">
                                            ...
                                            <tbody>
                                              <?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    <td><?php echo $v['id']; ?></td>
                                                    <td><a value="<?php echo url('Curriculum/edit_ks',['id'=>$v['id']]); ?>" cate="2" class="iframe" style="cursor: pointer"><?php echo $v['title']; ?></a></td>
                                                    <td><?php echo $v['video']; ?></td>
                                                    <td>
                                                        <span class="iframe ispan" value="<?php echo url('Curriculum/edit_ks',['id'=>$v['id']]); ?>" cate="2">
                                                        编辑
                                                       </span>
                                                        <span class="ispans" onclick="del_ks(<?php echo $v['id']; ?>)">
                                                        删除
                                                       </span>
                                                    </td>
                                                </tr>
...
<script>
    ...
    function del_ks(id){
        layer.confirm('确定删除？',{'icon':3,'title':'删除'},function(data){
            $.post('/xyb/Curriculum/del_ks',{id:id},function(res){
                if(res.state==1){
                    layer.msg(res.info, {
                        icon: 1,
