<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:73:"D:\PHPTutorial\WWW\xx\public/../application/xyb\view\curriculum\edit.html";i:1563693152;s:59:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\head.html";i:1563603505;s:61:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\header.html";i:1563603560;s:62:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\sidebar.html";i:1563692524;s:66:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\breadcrumbs.html";i:1563610337;s:58:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\set.html";i:1562840357;s:61:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\footer.html";i:1562840357;s:63:"D:\PHPTutorial\WWW\xx\application\xyb\view\Public\footerjs.html";i:1562897379;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <div id="sidebar" class="sidebar responsive">
        ...
        <ul class="nav nav-list">
            ...
            <li class="">
                ...
                <ul class="submenu" <?php if(in_array(($tag_id), explode(',',"2,3"))): ?>style="display:block"<?php endif; ?>>
                    <li <?php if($tag_id == 3): ?>class='active' <?php endif; ?>>
                        <a href="<?php echo url('course/index',['tag_id'=>3]); ?>">
            ...
            <li class="">
                ...
                <ul class="submenu" <?php if(in_array(($tag_id), explode(',',"4,5"))): ?>style="display:block"<?php endif; ?>>
                    <li <?php if($tag_id == 5): ?>class='active' <?php endif; ?>>
                        <a href="<?php echo url('Curriculum/index',['tag_id'=>5]); ?>">
                            <i class="menu-icon fa fa-caret-right"></i>
                            课程列表
                        </a>
            ...
            <li class="">
                ...
                <ul class="submenu" <?php if(in_array(($tag_id), explode(',',"6"))): ?>style="display:block"<?php endif; ?>>
                    <li <?php if($tag_id == 6): ?>class='active' <?php endif; ?>>
                        <a href="<?php echo url('Test/index',['tag_id'=>6]); ?>">
                            <i class="menu-icon fa fa-caret-right"></i>
                            分类列表
                        </a>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="tabbable">
                                    ...
                                    <form class="form-horizontal margin-top-20" action="<?php echo url('Curriculum/edit_post',['tag_id'=>$tag_id]); ?>" method="post" onsubmit="return check()" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-10">
                                                <select name="p_id" id="p_id">
                                                    ...
                                                    <option value="<?php echo $v['id']; ?>" <?php if($info['p_id'] == $v['id']): ?>selected="selected"<?php endif; ?>><?php echo $v['name']; ?></option>
                                                    <<?php endforeach; endif; else: echo "" ;endif; ?>>
                                                </select>
                                                <select name="p_next_id" id="p_next_id">
                                                    <option>请选择二级分类</option>
                                                    <<?php if(is_array($cat_next) || $cat_next instanceof \think\Collection || $cat_next instanceof \think\Paginator): $i = 0; $__LIST__ = $cat_next;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vs): $mod = ($i % 2 );++$i;?>>
                                                    <option value="<?php echo $vs['id']; ?>" <?php if($info['p_next_id'] == $vs['id']): ?>selected="selected"<?php endif; ?>><?php echo $vs['name']; ?></option>
                                                    <<?php endforeach; endif; else: echo "" ;endif; ?>>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-10">
                                                <input type="text" class="form-control" id="input-name" name="curriculum_name" value="<?php echo $info['curriculum_name']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-name" class="col-sm-2 control-label"><span style="color: red">*</span>课程简介</label>
                                            <div class="col-md-6 col-sm-10">
                                                <textarea type="text" class="form-control" id="input-name" name="curriculum_intro" rows="8"><?php echo $info['curriculum_intro']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-name" class="col-sm-2 control-label"><span style="color: red">*</span>课程分数</label>
                                            <div class="col-md-6 col-sm-10">
                                                <input type="text" class="form-control" id="input-name" name="curriculum_score" value="<?php echo $info['curriculum_score']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-name" class="col-sm-2 control-label"><span style="color: red">*</span>课程学习时间(分钟)</label>
                                            <div class="col-md-6 col-sm-10">
                                                <input type="text" class="form-control" id="input-name" name="curriculum_min" value="<?php echo $info['curriculum_min']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="input-name" class="col-sm-2 control-label"><span style="color: red">*</span>图片简介</label>
                                            <div class="col-md-6 col-sm-10">
                                                <img src="/uploads/<?php echo $info['pic']; ?>" style="width: 200px; height: 200px;" id="imgs"/>
